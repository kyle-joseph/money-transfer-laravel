            ...
            <div class="container">
                ...
                <div class="login-form">
                    <div class="content">
                        ...
                        <form action="<?php echo e(route('login')); ?>" onsubmit="return loginValidation()" method="POST">
                            <?php echo csrf_field(); ?>   
                            <div class="log">
...
<?php /**PATH /home/kylepc/MEGAsync/Web Projects/pinakalatest/Web-Project/resources/views/auth/login.blade.php ENDPATH**/ ?>