        ...
        <div class="wrapper">
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <a href="/transactions"><li class="<?php echo e('transactions' == request()->path() || 'transactions/unclaimed' == request()->path() || 'transactions/claimed' == request()->path() || 'transactions/unclaimed/edit' == request()->path()?'active':''); ?>"><i class="fa fa-money"></i>Transactions</li></a>
                </ul>
            </div>
            <nav class="header">
...
<?php /**PATH /home/kylepc/MEGAsync/Web-Project/resources/views/layouts/layout.blade.php ENDPATH**/ ?>