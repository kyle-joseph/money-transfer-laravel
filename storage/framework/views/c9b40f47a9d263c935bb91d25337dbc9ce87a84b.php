                        ...
                        <?php $__currentLoopData = $senders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><input type="submit" value="Edit" onclick="event.preventDefault();
                                    document.getElementById('logout-form').submit();"></td>
                                <form id="logout-form" action="/transactions/unclaimed/edit" method="GET" style="display: none;">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kylepc/MEGAsync/Web-Project/resources/views/transactions/unclaimed.blade.php ENDPATH**/ ?>